        ...
        {!localStorage.getItem('token') ? 
         ...
         : 
          <button
            ...
            className="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 text-center md:ml-3 md:mr-0 md:w-auto dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
          >
            Logout
          </button>
        }
